/**
 * This is a highly modified component specifically for
 * Heartwise Walkthrough Mode
 * Double check all the dependency before using
 * it as a general component
 */
...
const windowHeight = (Platform.OS == 'android') ? ExtraDimensions.getRealWindowHeight() : Dimensions.get('window').height;
...
export default class VideoPlayer extends Component {
    ...
    initSeekPanResponder() {
        this.player.seekPanResponder = PanResponder.create({
            ...
            onPanResponderMove: (evt, gestureState) => {
                const position = this.state.seekerOffset + gestureState.dy;
                this.setSeekerPosition(position);
            },
    ...
    */
    ...
    renderPlayPause() {
        ...
        return this.renderControl(
            <Image source={source} style={{ height: 30, width: 30 }} resizeMode="contain" />,
...
const styles = {
    player: StyleSheet.create({
        container: {
            ...
            transform: [
                { rotate: '90deg' },
                { translateX: ((windowHeight - windowWidth) / 2) },
